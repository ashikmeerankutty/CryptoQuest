...
public class ThirdwebSDKDemos : MonoBehaviour
{
    ...
    public static ThirdwebSDKDemos Instance;
    ...
    public GameObject metamaskConnectButton;
    public GameObject coinbaseConnectButton;
    ...
    public WalletProvider selectedWalletProvider;
    ...
    void Start()
    {
        ...
        sdk = new ThirdwebSDK("mumbai",new ThirdwebSDK.Options()
                {
                    gasless =
    ...
    async private void InitializeState()
    {
    ...
    public async void DisconnectWallet()
    {
        ...
        connectButtonsContainer.SetActive(true);
        walletInfoContainer.SetActive(false);
        SceneManager.UnloadSceneAsync("LoginGame");
    ...
    public async void ConnectMetamaskWallet() {
        ...
        try {
            ...
            walletInfotext.text = "SIGNED IN AS";
    ...
    public async void ConnectCoinbaseWallet() {
        connectButtonsContainer.SetActive(false);
        walletInfoContainer.SetActive(true);
        walletInfotext.text = "Connecting...";
        walletProvider = WalletProvider.CoinbaseWallet;
        try {
            string address = await sdk.wallet.Connect(new WalletConnection()
            {
    ...
    private async void ConnectWallet(WalletProvider provider)
    {
        ...
        try
        {
            ...
            {
                provider = provider,
                chainId = 80001 // Switch the wallet Polygon on connection
            });
    ...
    public async void OnBalanceClick()
    {
        ...
        // balanceText.text = balance.displayValue.Substring(0, 5) + " " + balance.symbol;
        }
    }
    ...
    {
        PlayerPrefs.SetString("SelectedProvider", Value);
    }
    ...
    public void OnPlayGame() {
        ...
        walletInfoContainer.SetActive(false);
        disconnectButton.SetActive(true);
        SceneManager.LoadScene("LoginGame", LoadSceneMode.Additive);
