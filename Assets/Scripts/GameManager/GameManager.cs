...
public class GameManager : SingletonMonobehaviour<GameManager>
{
    ...
    {
        return sdk.GetContract("0x55Be31E3700A4021a4d6e7fa84C8b3231eDA536D");
    }
    ...
    {
        return sdk
            .GetContract("0x136EA5Da1b4e5Dd4aA20D4519cf226D02A58D4ee")
            .marketplace;
    }
    ...
    public async void BuySniper() {
       var result = await GetMarketplaceContract().BuyListing("6", 1);
    ...
    var result = await GetMarketplaceContract().BuyListing("5", 1);
       if(result.isSuccessful()) {
        mp7BuyButton.SetActive(false);
        mp7BoughtButton.SetActive(true);
        GetPlayer().AddWeaponToPlayer(playerDetails.mp7Weapon);
    ...
    public async void BuyLaser() {
        var result = await GetMarketplaceContract().BuyListing("4", 1);
        if(result.isSuccessful()) {
            laserBuyButton.SetActive(false);
            laserBoughtButton.SetActive(true);
                    GetPlayer().AddWeaponToPlayer(playerDetails.laserWeapon);
    ...
    {
        return sdk.GetContract("0x9561D145Da4983eb66Df22080864119C99Bc04ca");
    }
